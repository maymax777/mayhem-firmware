 ...
 */
void computeRange(range_tt *rho, ephem_t eph, ionoutc_t *ionoutc, gpstime_t g, double xyz[])
{
 ...
 */
void computeCodePhase(channel_t *chan, range_tt rho1, double dt)
{
	double ms;
	int ims;
	double rhorate;
...
*/
	...
	neph = readRinexNavAll(eph, &ionoutc, file_path);
